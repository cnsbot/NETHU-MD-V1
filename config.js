...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "yT5WVRLT#KNPW-6eOHna9vU0MDV81-eFHRo4zulHqvE7p38Gg7Dg",
...
OWNER_NAME: process.env.OWNER_NAME || "NSS ERROR",
BOT_NAME: process.env.BOT_NAME || "Ne",
