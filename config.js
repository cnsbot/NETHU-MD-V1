...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "0r1TVAxL#NrenrK1O5pdZvgKuEZ9maeU4aWOlTkGg_6NcfFbQzMc",
...
OWNER_NAME: process.env.OWNER_NAME || "CNS ERROR",
BOT_NAME: process.env.BOT_NAME || "CNSS-MD",
